...
interface AdbClient {
    ...
    /**
     * Current adb executable absolute path.
     */
     ...
     */
    suspend fun validateAdbExecPath(): OperationResult
     ...
     */
    suspend fun executeShell(device: AndroidDevice, command: String): String
}